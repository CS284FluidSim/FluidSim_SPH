...
void init_sph_system()
{
	...
	simsystem->add_cube_fluid({ 0.3f, 0.3f, 0.3f }, { 1.0f, 0.9f, 0.8f });
...
void init_marching_cube()
{
	...
	marchingcube = new FluidSim::MarchingCube(row_vox, col_vox, len_vox, model_scalar, model_vox, sim_ratio, real_world_origin, vox_size, 8.0f);
}
